...
architecture behavioral of fir_tb is
    ...
    signal x_sig     : std_logic_vector(11 downto 0) := (others => '0');
...
begin
    ...
    begin
        ...
        for i in 0 to N_SAMPLES - 1 loop
            ...
            if i = 0 then
                x_sig <= std_logic_vector(to_signed(1, 12));
            elsif i = 15 then
                x_sig <= std_logic_vector(to_signed(2, 12));
            else
                x_sig <= std_logic_vector(to_signed(0, 12));
            end if;
